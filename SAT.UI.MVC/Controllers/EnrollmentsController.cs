...
namespace SAT.UI.MVC.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        {
            ViewBag.ScheduledClassId = new SelectList(db.ScheduledClasses, "ScheduledClassId", "Description");
        ...
        public ActionResult Create([Bind(Include = "EnrollmentId,StudentId,ScheduledClassId,EnrollmentDate")] Enrollment enrollment)
        {
            ...
            ViewBag.ScheduledClassId = new SelectList(db.ScheduledClasses, "ScheduledClassId", "Description", enrollment.ScheduledClassId);
